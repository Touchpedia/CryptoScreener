          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            {chartSelection ? (
              <span style={{ fontSize: 12, color: "#334155" }}>
                {chartSelection.symbol} ┬À {chartSelection.timeframe}
              </span>
            ) : (
              <span style={{ fontSize: 12, color: "#475569" }}>
              ...
              >
                {websocketSummary.aboveLimit
                  ...
                  : websocketSummary.headroom > 0
                    ...
                    : "At capacity ÔÇö expand budget or pause some streams."}
              </span>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: 12, color: "#0f172a" }}>
                Watch {websocketSummary.watch.toLocaleString()} ÔÇó Needs attention{" "}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ fontSize: 11, color: palette.color }}>
                          {palette.label} ÔÇó {item.driftLabel}
                        </div>
                      </li>
                    );
                  })}
                              ...
                              >
                                {stat.timeframes.map((tf) => (
                                  <span
                                    ...
                                    title={`${tf.timeframe.toUpperCase()} ÔÇó ${tf.coveragePct.toFixed(
                                      1,
                                    )}% ÔÇó latest ${tf.latestLabel}`}
                                    style={{
                                      display: "inline-flex",
                                      alignItems: "center",
                                      gap: 6,
                      ...
                      return (
                        ...
                        >
                          ...
                          <td style={{ padding: "12px 16px" }}>
                            ...
                            >
                              {palette.label} ┬À {row.freshnessLabel}
                            </span>
                          </td>
                        </tr>
                      );
